package com.example.dedwards.todoapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // obtain a reference to listView object in the layout
        lvItems = (ListView) findViewById(R.id.lvItems);
        // initialize the items list by reading in items
        readItems();
    ...
    private void setupListViewListener() {
        ...
        lvItems.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                writeItems();
                // display a notification to the user
                Toast.makeText(getApplicationContext(),"Item has been removed from list", Toast.LENGTH_SHORT).show();
